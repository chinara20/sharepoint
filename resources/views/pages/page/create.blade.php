...
<div class="allcp-form theme-primary tab-pane mw600 active" id="register" role="tabpanel">
   <div class="panel">
      ...
      <!-- -------------- /Panel Heading -------------- -->
      <form method="post" action="{{ route('page.store') }}" method="POST" >
      	{!! csrf_field() !!}
         <div class="panel-body pn">
            <div class="section row">
               <div class="col-md-6 ph10 mb5">
                  <label for="title" class="field prepend-icon">
                  <input type="text" name="title" id="title" class="gui-input" placeholder="Başlıq">
               ...
               <!-- -------------- /section -------------- -->
               <div class="col-md-6 ph10 mb5">
                  <label for="slug" class="field prepend-icon">
                  <input type="text" name="slug" id="slug" class="gui-input" placeholder="Slug">
