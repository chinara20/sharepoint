...
var app = new Vue({
    ...
    data: {
        ...
        socketConnected : {
            status: false,
            msg: 'Xəttə bağlanılır. Zəhmət olmasa gözləyin'
        },
        bArr: {}
    },
    methods: {
...
var chatbox = {
    ...
    template: `
        <div class="chat_box" v-bind:id="'chatbox-' + cChat.id" style="right:10px">
         ...
         <ul>
            ...
            <li>🧐</li>
                        ...
                        <input name="message" v-bind:id="'msginput-' + cChat.id" v-model.trim="message" placeholder="Mesajınızı daxil edin" class="form-control" type="text" v-on:keydown="sendMessage($event)">
                        <button class="smile_icons">Sml</button>  
